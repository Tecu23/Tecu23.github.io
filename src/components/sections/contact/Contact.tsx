                    ...
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <Reveal>
                            <p className="text-lg lg:paragraph-16 text-white text-center lg:text-left">
                                Feel free to get in touch, it will be a great
                                pleasure to be able to help you with your
                                project, contact me now!
                            </p>
                        </Reveal>
                    </div>
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <Reveal>
                            <div className="flex gap-2 text-primary">
                                ...
                                <p className="paragraph-16 text-white pt-1">
                                    andrei.teculescu@gmail.com
                                </p>
                            </div>
                        </Reveal>
                    </div>
