            ...
            <div className="w-full flex flex-col items-start justify-center flex-grow flex-shrink flex-auto">
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col">
                        <p className="paragraph-14 lg:paragraph-16 text-primary">Frontend Developer</p>
                    ...
                    <div className="flex flex-col gap-12">
                        <p className="text-xl lg:text-2xl font-light leading-8 line-clamp-2 text-white">Let's develop your next successful product together!</p>
