                ...
                <div className="w-full flex flex-col items-center gap-16">
                    <Reveal>
                        <div className="flex gap-2">
                            <h2 className="heading-4 lg:heading-2 text-white">Projects</h2>
                    ...
                    {projects.map((project, idx) => (
                        <div key={idx} className="w-full flex flex-col lg:flex-row items-center gap-16">
                            ...
                            >
                                <img src={project.img} className="w-full h-full object-cover rounded-lg" />
                            </div>
                            <div className={`flex flex-col justify-center ${idx % 2 == 1 ? "items-start lg:items-end" : "lg:items-start"} flex-shrink flex-grow flex-auto gap-8`}>
                                ...
                                <Reveal>
                                    <p className="text-lg lg:paragraph-16 text-white">{project.description}</p>
                                </Reveal>
                                <Reveal>
                            ...
                            >
                                <img src={project.img} className="w-full h-full object-contain rounded-lg" />
                            </div>
                        </div>
                    ))}
                </div>
