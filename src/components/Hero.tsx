                ...
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-start">
                            <h2 className="heading-2 text-white line-clamp-2">Andrei-Raul Teculescu</h2>
                    ...
                    <div className="flex flex-col gap-12">
                        <p className="text-2xl font-light leading-8 line-clamp-2 text-white">Let's develop your next successful product together!</p>
                        <div className="flex items-center gap-4">
                            <button className="h-12 px-5 py-3 bg-primary-dark hover:bg-primary rounded-md">
                                <p className="font-semibold tracking-wide text-white">View My Projects</p>
                            </button>
                            <button className="h-12 px-5 py-3 border-primary hover:border-primary-dark rounded-md border">
                                <p className="font-semibold tracking-wide text-primary hover:text-primary-dark">Contact Me</p>
                            </button>
                        </div>
                    </div>
                </div>
