    ...
    return (
        <main className="bg-grey-900 w-full min-h-screen">
            <section className="overflow-hidden relative z-10">
                ...
                <div
                    style={{ zIndex: 5 }}
                    className="absolute right-1/4 top-0 opacity-25 w-[160px] h-[160px] rounded-full blur bg-gradient-to-r from-primary to-primary-dark flex-center transform -translate-y-[50px]"
                >
